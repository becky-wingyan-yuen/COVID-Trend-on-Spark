...
```{r plot1, fig.cap="Change in the number of cases by country", out.width="60%", fig.align='center'}
...
```{r plot2, fig.cap="Change in rate by country", out.width="60%", fig.align='center'}
